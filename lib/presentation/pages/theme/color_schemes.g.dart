...
const customColorScheme11 = CupertinoThemeData(
  ...
  primaryColor: Color(0xFF0000FF), // Blue as the primary contrasting color
  primaryContrastingColor: Color(0xFF000000), // Black as the primary color
  scaffoldBackgroundColor: Color(0xFF000080), // Navy Blue as the scaffold background color
