...
_$AppearanceImpl _$$AppearanceImplFromJson(Map<String, dynamic> json) => _$AppearanceImpl(
...
Map<String, dynamic> _$$AppearanceImplToJson(_$AppearanceImpl instance) => <String, dynamic>{
