...
const customcolor1 = Color(0xFFBF94E8);

CustomColors lightCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFBF94E8),
  customcolor1: Color(0xFF744B9D),
  onCustomcolor1: Color(0xFFFFFFFF),
  customcolor1Container: Color(0xFFF0DBFF),
  onCustomcolor1Container: Color(0xFF2C0051),
);

CustomColors darkCustomColors = const CustomColors(
  sourceCustomcolor1: Color(0xFFBF94E8),
  customcolor1: Color(0xFFDDB8FF),
  onCustomcolor1: Color(0xFF441A6B),
  customcolor1Container: Color(0xFF5B3383),
  onCustomcolor1Container: Color(0xFFF0DBFF),
);
